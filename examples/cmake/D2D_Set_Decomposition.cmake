...
message(STATUS "Computed NRANK: ${NUMPROCS} Max avail ${MPI_NUMPROCS}")
set(ADD_DECOMP_TO_EXAMPLE FALSE)
if (NUMPROCS GREATER "0")
  if (NUMPROCS LESS "${MPI_NUMPROCS}")
    message(STATUS "Decomposion has been imposed to ${PROW}X${PCOL}: number of MPI tasks to be used is imposed to ${NUMPROCS}")
    set(MPI_NUMPROCS "${NUMPROCS}" CACHE STRING "Force N to be p_row*p_col" FORCE)
  else ()
    message(STATUS "The decomposition ${PROW}x${PCOL} cannot be run. Only ${MPI_NUMPROCS} are available. Default testing is performed")
  endif()
endif ()
