...
#
f.write("\n")
f.write("   interface decomp_2d_read_scalar\n")
for i in range(nformat):
    f.write("      module procedure read_scalar_"+ext[i]+"\n")

f.write("   end interface decomp_2d_read_scalar\n")
f.write("\n")
...
for i in range(nformat):
    ...
    # Header
    #
    f.write("   subroutine read_scalar_"+ext[i]+"(io, n, var, opt_mpi_datarep)\n")
    f.write("\n")
    ...
    # Start profiling
    #
    f.write("      if (decomp_profiler_io) call decomp_profiler_start(\"io_read_scalar\")\n")
    f.write("\n")
    #
    # Call the lower level IO subroutine
    #
    if (i==0 or i==1 or i==2 or i==3 or i==4 or i==5):
        f.write("      call read_scalar(io, n, &\n")
    ...
    # End profiling
    #
    f.write("      if (decomp_profiler_io) call decomp_profiler_end(\"io_read_scalar\")\n")
    f.write("\n")
    #
    # Footer
    #
    f.write("   end subroutine read_scalar_"+ext[i]+"\n")
    f.write("   !\n")
