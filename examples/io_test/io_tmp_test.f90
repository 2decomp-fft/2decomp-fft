...
program io_test
   ...
   call decomp_2d_register_variable(io_name, "v1.dat", 1, 0, output2D, data_type, mytype)
   call decomp_2d_register_variable(io_name, "v2.dat", 2, 0, output2D, data_type, mytype)
   call decomp_2d_register_variable(io_name, "v3.dat", 3, 0, output2D, data_type, mytype)
   ...
   call decomp_2d_register_variable(io_restart, "v1.dat", 1, 0, output2D, data_type, mytype)
   call decomp_2d_register_variable(io_restart, "v2.dat", 2, 0, output2D, data_type, mytype)
   call decomp_2d_register_variable(io_restart, "v3.dat", 3, 0, output2D, data_type, mytype)
